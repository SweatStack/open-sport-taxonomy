"""Property-based tests for encode/decode across all five platforms.
...
ALL_PLATFORMS = [garmin_fit, strava, apple_healthkit, garmin_training_api, wahoo]
...
@given(sport=standard_sports(), platform_index=st.integers(min_value=0, max_value=4))
